...
async def kuaidaili(page_start: int = 1, page_end: int = 1, headers={}, timeout: int = 10, semaphore: int = 10, **kwargs) -> CRAW_RET:
    """
    快代理 https://www.kuaidaili.com
...
async def nimadaili(page_start: int = 1, page_end: int = 1, headers={}, timeout: int = 10, semaphore: int = 10, **kwargs) -> CRAW_RET:
    """
    泥马代理 http://www.nimadaili.com
